          ...
          <Row className=" pb-5 align-items-center">
            ...
            <Col>
              <Row className=" align-items-start p-2 my-details rounded tex align-text-left ">
                ...
                Firestore, HTML and CSS. currently learning React Native for
                Mobile Application.
                <br />
                <br />
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a
                      href="https://docs.google.com/document/d/1e25LlMhkTPj4BwkhXXKHvZsziwsUDaTgU4gPsIHzKIY/edit?usp=sharing"
                      target="_blank"
                  ...
                  <div>
                    <a
                      href="https://github.com/AdibaAbid"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <div>
                    <a
                      href="https://www.linkedin.com/in/adiba-abid-2658b9199/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
